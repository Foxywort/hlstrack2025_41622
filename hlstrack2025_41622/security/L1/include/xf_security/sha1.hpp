...
#pragma HLS EXPRESSION_BALANCE off
                ...
                ap_uint<w> T;
                if (t < 20) {
                    ap_uint<w> t1 = ROTL<w>(5, a) + Ch<w>(b, c, d);
#pragma HLS bind_op variable=t1 op=add impl=dsp
                    ap_uint<w> t2 = t1 + e;
#pragma HLS bind_op variable=t2 op=add impl=dsp
                    ap_uint<w> t3 = t2 + K[t / 20];
#pragma HLS bind_op variable=t3 op=add impl=dsp
                    T = t3 + Wt;
#pragma HLS bind_op variable=T op=add impl=dsp
                } else if ((40 <= t) && (t < 60)) {
                    ap_uint<w> t1 = ROTL<w>(5, a) + Maj<w>(b, c, d);
#pragma HLS bind_op variable=t1 op=add impl=dsp
                    ap_uint<w> t2 = t1 + e;
#pragma HLS bind_op variable=t2 op=add impl=dsp
                    ap_uint<w> t3 = t2 + K[t / 20];
...
#pragma HLS bind_op variable=T op=add impl=dsp
                    ...
                    ap_uint<w> t1 = ROTL<w>(5, a) + Parity<w>(b, c, d);
#pragma HLS bind_op variable=t1 op=add impl=dsp
                    ap_uint<w> t2 = t1 + e;
#pragma HLS bind_op variable=t2 op=add impl=dsp
                    ap_uint<w> t3 = t2 + K[t / 20];
