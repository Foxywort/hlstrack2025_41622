...
#pragma HLS EXPRESSION_BALANCE off
            ap_uint<32> A_new = A + AA;
#pragma HLS bind_op variable=A_new op=add impl=dsp
            ap_uint<32> B_new = B + BB;
#pragma HLS bind_op variable=B_new op=add impl=dsp
            ap_uint<32> C_new = C + CC;
#pragma HLS bind_op variable=C_new op=add impl=dsp
            ap_uint<32> D_new = D + DD;
#pragma HLS bind_op variable=D_new op=add impl=dsp
